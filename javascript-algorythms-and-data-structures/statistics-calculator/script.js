...
// The below function is called from the HTML FORM attribute submit. The function is followed by return false  <form onsubmit="calculate(); return false;">
const calculate = () => {
    const value = document.querySelector('#numbers').value;
    const array = value.split(/,\s*/g); // regex is not betwwen ''
