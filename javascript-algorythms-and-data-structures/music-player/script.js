...
audio.addEventListener('ended', () => {
    const currentSongIndex = getCurrentSongIndex();
    // const nextSongExists = currentSongIndex < userData?.songs.length - 1 ? true : false; // My accepted code
    const nextSongExists = userData?.songs[currentSongIndex + 1] !== undefined; // fCC code
...
const highlightCurrentSong = () => {
    ...
    if (songToHighlight) {
        songToHighlight.setAttribute("aria-current", "true"); // Both arguments are between ""
    }
}
