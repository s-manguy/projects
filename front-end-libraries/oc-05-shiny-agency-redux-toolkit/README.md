# Shiny Agency : Manage the state of your React Router SPA with Redux and the Redux Toolkit
...
* the [Utilisez le state manager redux pour gérer l'état de vos applications](https://openclassrooms.com/fr/courses/7150626-utilisez-le-state-manager-redux-pour-gerer-l-etat-de-vos-applications/7286883-ecrivez-moins-de-code-grace-a-redux-toolkit) de Etienne Deladonchamps.
...
* Install **redux toolkit ** in a redux-react app.
* Use **configureStore**, **createAction** & **createReducer**.
* Use **middlewares**, **Redux-Thunk** & **thunk creators**.
* Use **createSlice**.
* Test the API with **jest** and **React Testing Library**.
