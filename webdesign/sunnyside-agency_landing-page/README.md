# Realise the Sunnyside agency landing page on figma  
...
2. Create the About us page and the Contact page to have the possibility to more realistic prototype.
3. Create header and footer overlays to represente the different states of various elements.
4. Add all the interactions and play the prototype.
